                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <tr>
                                <th>#</th>
                                <th>اسم التخصص باللغة العربية</th>
                                <th>اسم التخصص باللغة الإنجليزية</th>
                                <th>الحالة</th>
                                <th>العمليات</th>
                            </tr>
                            </thead>
                            ...
                            @foreach ($specialties as $item)
                                ...
                                @include('specialties.edit')

                                <!--  page of delete_modal_city -->
                                @include('specialties.delete')


                            @endforeach
                        </table>

                        <div> {{$specialties->links('pagination::bootstrap-4')}}</div>
                    </div>
                </div>
            </div>
        </div>
