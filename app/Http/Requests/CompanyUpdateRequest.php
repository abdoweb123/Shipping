...
class CompanyUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pre_image' => 'file|mimes:jpg,jpeg,png,svg',
            'commercialRecord_image' => 'file|mimes:jpg,jpeg,png,svg',
            'licence_image' => 'file|mimes:jpg,jpeg,png,svg',
            'pre_agent_image' => 'file|mimes:jpg,jpeg,png,svg',
            'national_address' => 'required',
            'services' => 'required',
            'jobs' => 'required',
            'contract_image' => 'file|mimes:jpg,jpeg,png,svg',
        ];
    }
